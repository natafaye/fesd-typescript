...
function renderLoginPage() {
    ...
    return `
        <form class="bg-light p-3 mx-auto mt-5 w-75">
...
function setUpLoginButton() {
    ...
    loginButton.addEventListener("click", (event) => {
        ...
        const matchingUser = userList.find(user => user.username === usernameInput.value)

        if(matchingUser && matchingUser.password === passwordInput.value) {
